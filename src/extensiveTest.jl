# test 1: extensive formulation vs. SDDP

# function recursionTest(linkData,currentNode,checkedNode)
#     push!(checkedNode,currentNode);
#     println(currentNode);
#     for i in linkData[currentNode]
#         if !(i in checkedNode)
#             recursionTest(linkData,i,checkedNode);
#         end
#     end
# end
