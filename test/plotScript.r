...
plot(1:20, dOnlylb1$V1[1:20], type = "l", xlim = range(c(1,100)), ylim=range(c(0,30000)), xlab = "Iteration", ylab = "LB", main = "Case 13",
      col = "#377EB8", lwd = 2, cex.main = 1.5, cex.lab = 1.5, cex.axis = 1.5, log="x");
...
plot(1:100, dOnlylb1$V3[1:100], type = "l", ylim=range(c(0,30000)), xlab = "Iteration", ylab = "LB", main = "Case 13",
     col = "#377EB8", lwd = 2, cex.main = 1.5, cex.lab = 1.5, cex.axis = 1.5);
...
legend("bottomright",c("N = 1","N = 5","N = 10","N = 15","N = 20"), , col = c("#377EB8","#E41A1C","#4DAF4A","#984EA3","#3CAEA3"),pch = 20,cex = 1.5);
...
legend("topleft",c("N = 1","N = 5","N = 10","N = 15","N = 20"), , col = c("#377EB8","#E41A1C","#4DAF4A","#984EA3","#3CAEA3"),pch = 20,cex = 1.5);
