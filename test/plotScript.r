...
par(mfrow=c(1,3));
par(mar = c(5,5,1.5,2.5));
plot(dOnlyt1$V1[1:20],dOnlylb1$V1[1:20], type = "l", xlim = range(c(80,10000)), ylim=range(c(0,30000)), xlab = "Time (sec.)", ylab = "LB", 
     col = "#377EB8", lwd = 2, cex.main = 2, cex.lab = 2, cex.axis = 2, log = "x");
lines(dOnlyt1$V2[1:100],dOnlylb1$V2[1:100], col = "#E41A1C", lwd = 2, log = "x");
legend("bottomright",c("GenAll","DOnly"), col = c("#377EB8","#E41A1C"),pch = 20,cex = 1.5);
plot(dOnlyt2$V1[1:20],dOnlylb2$V1[1:20], type = "l", xlim = range(c(30,28000)), ylim=range(c(0,38000)), xlab = "Time (sec.)", ylab = "LB", 
     col = "#377EB8", lwd = 2, cex.main = 2, cex.lab = 2, cex.axis = 2, log="x");
lines(dOnlyt2$V2[1:100],dOnlylb2$V2[1:100], col = "#E41A1C", lwd = 2, log="x");
legend("bottomright",c("GenAll","DOnly"), col = c("#377EB8","#E41A1C"),pch = 20,cex = 1.5);
plot(dOnlyt3$V1[1:20],dOnlylb3$V1[1:20], type = "l", xlim = range(c(100,63000)), ylim=range(c(0,50000)), xlab = "Time (sec.)", ylab = "LB", 
     col = "#377EB8", lwd = 2, cex.main = 2, cex.lab = 2, cex.axis = 2, log="x");
...
par(mar = c(5,5,1.5,2.5));
plot(dOnlyt1$V3[1:100], dOnlylb1$V3[1:100], type = "l", xlim=range(c(0,2500)), xlab = "Time (sec.)", ylab = "LB", 
     col = "#377EB8", lwd = 2, cex.main = 2, cex.lab = 2, cex.axis = 2);
lines(dOnlyt1$V2[1:100], dOnlylb1$V2[1:100], col = "#E41A1C", lwd = 2);
legend("bottomright",c("Pre-generated cuts","No pre-generated cuts"), col = c("#377EB8","#E41A1C"),pch = 20,cex = 1.5);
plot(dOnlyt2$V3[1:100], dOnlylb2$V3[1:100], type = "l", xlim=range(c(0,5500)), xlab = "Time (sec.)", ylab = "LB",
     col = "#377EB8", lwd = 2, cex.main = 2, cex.lab = 2, cex.axis = 2);
lines(dOnlyt2$V2[1:100], dOnlylb2$V2[1:100], col = "#E41A1C", lwd = 2);
legend("bottomright",c("Pre-generated cuts","No pre-generated cuts"), col = c("#377EB8","#E41A1C"),pch = 20,cex = 1.5);
plot(dOnlyt3$V3[1:100], dOnlylb3$V3[1:100], type = "l", xlim=range(c(0,20000)), xlab = "Time (sec.)", ylab = "LB",
     col = "#377EB8", lwd = 2, cex.main = 2, cex.lab = 2, cex.axis = 2);
